...
public class ParseSignupFragment extends ParseLoginFragmentBase implements OnClickListener {
  ...
  private CheckBox isLecturerCheckbox;
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup parent,
    ...
    isLecturerCheckbox = (CheckBox) v.findViewById(R.id.is_lecturer_checkbox);
  ...
  public void onClick(View v) {
    ...
    if (username.length() == 0) {
      ...
      user.put("isLecturer", isLecturerCheckbox.isChecked());
      user.setEmail(email);
